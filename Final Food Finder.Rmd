...
The goals of this project are to help students predict the best days to look for lunch being offered on campus with details about what types of events accompanied them. We would like to learn about the availability, frequency, and quality of these lunches. Benefits to knowing this information are that it could help students plan for when not to buy or bring lunch and would save, for those who are interested, money on food, which is ideal for graduate students on a tight budget. Student government and other student groups could also benefit so as to have a general idea for next year what times of the year have the most options so that they can optimize the number of students they draw to their event, i.e. if students have too many options, it could hurt attendance at their event. 
...
Initially, our questions specifically targeted events offering a free lunch.  We were interested in determining which location, event topic, day of the week, week of the semester, etc. had the most free food events.  To do this, we planned on collecting information only related to events accompanied by free meals.  However, once the data collection process began, we decided to ensure collection of all applicable events by collecting all event data.  Subsequently, our main focus changed a bit from quantifying aspects of only the free food events, to comparing events with food to those without, in addition to our main questions of interest. 
